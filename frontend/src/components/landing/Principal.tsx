...
export interface PrincipaisProps {
	tecnologias: Tecnologia[]
}

export default function Principal(props: PrincipaisProps) {
	return (
		<div className="flex w-full flex-col items-center justify-center h-[500px] bg-[url('/principal.png')] bg-cover bg-center">
			...
			<div className="flex-1 flex flex-col justify-center items-center gap-5">
				<div className="flex flex-col items-center gap-1">
					...
					<h2 className="text-zinc-500 text-center">Desenvolvedor de Software</h2>
				</div>
